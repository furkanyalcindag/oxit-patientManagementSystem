...
def send_mail(service,to):
    ...
    for product in products:
      ...
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;">'''+str(product.quantity)+'''</td>
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;">'''+str(product.netPrice)+'''</td>
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;">'''+str(product.taxRate)+'''</td>
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;">'''+str(product.totalProduct)+'''</td>
    </tr>'''
    if situation == "Müşteri Onayı Bekleniyor":
      ...
      '''+ product_table+'''</tbody>
        ...
        <tr>
          ...
          <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">'''+str(service.price) +'''</td>
          ...
          <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">'''+str(service.totalPrice) +'''</td>
        </tr>
        </tfoot>
      </table>'''
    else:
      ...
      <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
        ...
        <tbody>
          <tr>
            ...
            <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b>Kilometre:</b>'''+str(service.serviceKM)+'''<br />
