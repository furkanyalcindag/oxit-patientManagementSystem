        ...
        try:
            if request.GET.get('id') is not None:
                ...
                data = Appointment.objects.filter(patient__profile__user__first_name__icontains=name,
                    ...
                    '-id')[
                       lim_start:lim_end]
                filtered_count = Appointment.objects.filter(patient__profile__user__first_name__icontains=name,
                ...
                api_object.recordsTotal = Appointment.objects.filter(isDeleted=False).count()
